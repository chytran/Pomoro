            ...
            <div class="max-w-7xl mx-auto px-4">
                <div class="flex justify-between">
                    <div class="flex space-x-7">
                        ...
                        <div class="pr-50">
                            <!-- Title Text in Mobile Header -->
                            <a class="md:hidden flex items-center py-4 pl-40">
                                <span class="font-semibold text-red-500 text-4xl"  style="font-family: 'Raleway',sans-serif; text-transform: uppercase;">History</span>
                            </a>
                        </div>
