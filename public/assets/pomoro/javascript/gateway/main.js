...
class BasicCharacterController {
  ...
  _LoadModels() {
    ...
    loader.setPath('<?=ASSETS ?>/pomoro/javascript/gateway/resources/man/');
...
class PomoroGateway {
  ...
  _Initialize() {
    ...
    const texture = loader.load([
        '<?=ASSETS ?>/pomoro/javascript/gateway/image/bluecloud_ft.jpg',
        '<?=ASSETS ?>/pomoro/javascript/gateway/image/bluecloud_bk.jpg',
        '<?=ASSETS ?>/pomoro/javascript/gateway/image/bluecloud_up.jpg',
        '<?=ASSETS ?>/pomoro/javascript/gateway/image/bluecloud_dn.jpg',
        '<?=ASSETS ?>/pomoro/javascript/gateway/image/bluecloud_rt.jpg',
        '<?=ASSETS ?>/pomoro/javascript/gateway/image/bluecloud_lf.jpg',
      ]);
    texture.encoding = THREE.sRGBEncoding;
    this._scene.background = texture;

    var textureLoader = new THREE.TextureLoader();
    const floorTexture = textureLoader.load('<?=ASSETS ?>/pomoro/javascript/gateway/image/floor.jpg');
